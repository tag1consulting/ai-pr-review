...
# (vcs/_finding_ids.py, slash/github_orchestration.py) all need to find
# "where the usage block starts/ends" without caring which mode produced the
# body they are re-reading. Before this, GitLab and Bitbucket anchored on
...
# in the comment's first line
# (ai_pr_review.slash.github_orchestration.parse_inline_comment_header
