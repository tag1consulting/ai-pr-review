...
| `ai_pr_review/analyzers/bridge.py` + `analyzers/native/*.py` | Native Python ports of all 17 static analyzers (13 from Epic 8, plus `docs-api-check`/`docs-missing-check`/`docs-ref-check`/`docs-drift-check`); bridge dispatches per-analyzer file-type gates |
