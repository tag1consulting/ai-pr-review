...
def test_dismissed_finding_stays_suppressed_after_fuzzy_update_drift() -> None:
    ...
    token stays put. If a human then dismisses that thread, github_ops.py
    ...
    # Simulate github_ops.py: a human replies `/ai-pr-review dismiss` on that
    ...
    # narrative of what the reverse F-id lookup can return. github_ops.py also
